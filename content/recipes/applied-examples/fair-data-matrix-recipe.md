...
- The second data source: article by [Magnard et al. Science.Jul 3;349(6243):81-3 (2015)](https://doi.org/10.1126/science.aab0696); this is an early work of the same group of authors of the first data source.
...
To further demonstrate the value of such study design driven data representation, we applied a similar FAIRification process on the second data source. The results of this comparison is also released via Zenodo (https://doi.org/10.5281/zenodo.2640919).
